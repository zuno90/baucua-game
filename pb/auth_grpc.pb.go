...
type AuthClient interface {
	...
	CheckAuth(ctx context.Context, in *Jwt, opts ...grpc.CallOption) (*User, error)
}
...
func (c *authClient) CheckAuth(ctx context.Context, in *Jwt, opts ...grpc.CallOption) (*User, error) {
	out := new(User)
...
type AuthServer interface {
	// Sends jwt to auth service
	CheckAuth(context.Context, *Jwt) (*User, error)
...
func (UnimplementedAuthServer) CheckAuth(context.Context, *Jwt) (*User, error) {
...
func _Auth_CheckAuth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).CheckAuth(ctx, req.(*Jwt))
	}
